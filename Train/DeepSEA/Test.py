...
from NeuralNetwork.DeepSEA.model import DeepSEA
...
TestDataSet = pd.read_csv('ValidateData.csv', sep=' ', header=None)
...
"""
    compile network
"""
Net = DeepSEA(TFs_cell_line_pair=NUM_CLASS)
...
j_score = jaccard_score(y_pred=predicted_value, y_true=ground_label, average='macro')
kappa = cohen_kappa_score(y1=predicted_value, y2=ground_label, labels=None)
